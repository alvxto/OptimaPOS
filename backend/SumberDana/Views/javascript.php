<script type="text/javascript">
    var table = 'tableSumberDana';
    var form = 'formSumberDana';

    $(() => {
        HELPER.fields = ['id'];

        HELPER.api = {
            index: APP_URL + 'sumberdana',
            store: APP_URL + 'sumberdana/store',
            show: APP_URL + 'sumberdana/show',
            update: APP_URL + 'sumberdana/update',
            destroy: APP_URL + 'sumberdana/destroy',
        };
        ...
        return new Promise((resolve, reject) => {
            var initTable = HELPER.initTable({
                ...
                columnDefs: [{
                    ...
                    targets: 1,
                    render: function(data, type, full, meta) {
                        return full.sumber_dana_kode;

                    }
                }, {
                    targets: 2,
                    render: function(data, type, full, meta) {
                        return full.sumber_dana_nama;
                    }
                }, {
                    targets: -1,
                    render: function(data, type, full, meta) {
