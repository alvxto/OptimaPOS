<form action="javascript:onSave()" method="post" id="formSumberDana" name="formSumberDana" autocomplete="off" enctype="multipart/form-data">
			...
			<div class="tab-content" id="myTabContent">
				<div class="tab-pane fade show active" id="tabGeneral" role="tabpanel">
					<div class="fv-row mb-5">
						...
						<input type="text" name="kode" class="form-control form-control-sm form-control-solid" placeholder="Masukkan Kode Sumber Dana" required />
					</div>
					<div class="fv-row mb-5">
						<label for="" class="required form-label">Nama</label>
						<input type="text" name="nama" class="form-control form-control-sm form-control-solid" placeholder="Masukkan Nama Sumber Dana" required />
					</div>
					<div class="fv-row mb-5">
