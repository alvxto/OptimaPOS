		...
		<div class="card shadow-sm rounded-3 m-7">
			<div class="card-body">
				<div class="d-flex justify-content-between mb-7">
					<h2 class="text-gray-700 fw-bold m-0"><i class="las la-cube fs-1 p-1 rounded-3 bg-light-primary" style="color: #1AA37A;"></i> Total Penjualan</h2>
				...
				<div class="d-flex mb-1">
					...
					<span class="text-gray-500 fs-7 align-self-end">Penjualan</span>
				</div>
				<div class="d-flex fw-bold">
					<i class="las la-arrow-circle-up fs-1 align-self-center me-2" style="color: #1AA37A;"></i>
					<p class="mt-1 mb-0 align-self-center" style="color: #1AA37A;"> + <span id="totalPekerjaanOneLastWeek"></span> Penualan Dalam 7 Hari</p>
				</div>
			</div>
		</div>
		<!-- <div class="card shadow-sm rounded-3 m-7">
