<script type="text/javascript">
	...
	$(() => {
		...
		HELPER.api = {
			...
			getPejabat: APP_URL + 'pekerjaan/getPejabat',
			generateDoc: APP_URL + 'pekerjaan/generateDoc',
			uploadDoc: APP_URL + 'pekerjaan/uploadDoc',
			newTermyn: APP_URL + 'pekerjaan/newTermyn',
			date: APP_URL + 'pekerjaan/date',
		};
