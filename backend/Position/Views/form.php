<form action="javascript:onSave()" method="post" id="formPosition" name="formPosition" autocomplete="off" enctype="multipart/form-data">
			...
			<div class="tab-content" id="myTabContent">
				<div class="tab-pane fade show active" id="tabGeneral" role="tabpanel">
					<div class="fv-row mb-5">
						...
						<input type="text" name="code" class="form-control form-control-sm form-control-solid" placeholder="Masukkan Kode Position" required />
					</div>
					<div class="fv-row mb-5">
						<label for="" class="required form-label">Nama</label>
						<input type="text" name="name" class="form-control form-control-sm form-control-solid" placeholder="Masukkan Nama Position" required />
					</div>

					<div class="fv-row mb-5">
						<label for="" class="form-label">Keterangan</label>
						<textarea name="descriptions" id="descriptions" class="form-control form-control-sm form-control-solid" placeholder="Keterangan"></textarea>
					</div>
					<div class="fv-row mb-5">
