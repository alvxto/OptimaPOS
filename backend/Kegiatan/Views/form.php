<form action="javascript:onSave()" method="post" id="formKegiatan" name="formKegiatan" autocomplete="off" enctype="multipart/form-data">
			...
			<div class="tab-content" id="myTabContent">
				<div class="tab-pane fade show active" id="tabGeneral" role="tabpanel">
					<div class="fv-row mb-5">
						...
						<input type="text" name="kode" class="form-control form-control-sm form-control-solid" placeholder="Masukkan Kode Kegiatan" required />
					</div>
					<div class="fv-row mb-5">
						<label for="" class="required form-label">Nama</label>
						<input type="text" name="nama" class="form-control form-control-sm form-control-solid" placeholder="Masukkan Nama Kegiatan" required />
					</div>
					<div class="fv-row mb-5">
						<label for="" class="form-label">Keterangan</label>
						<textarea type="text" name="keterangan" id="keterangan" class="form-control form-control-sm form-control-solid" placeholder="Keterangan"></textarea>
					</div>
					<div class="fv-row mb-5">
						<label for="" class="form-label">Program</label>
						<select name="programId" id="programId" class="form-select form-select-sm form-select-solid" data-control="select2" data-allow-clear="true" data-placeholder="Select Program"></select>
					</div>
					<div class="fv-row mb-5">
