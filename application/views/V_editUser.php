...
<li class="breadcrumb-item"><a href="<?php echo base_url() ?>C_user/index">User</a></li>
...
<form action="<?php echo base_url() ?>C_user/editDataAksi" method="post">
<div class="card-body">
	<?php foreach ($user as $us) :?>
<div class="form-group">
<label for="username" hidden>id</label>
<input type="text" name="id" id="id" class="form-control" value="<?php echo $us['id_user'] ?>" hidden>
</div>
<div class="form-group">
<label for="username">Username</label>
<input type="text" name="username" id="username" class="form-control" placeholder="Enter Username" value="<?php echo $us['username'] ?>">
</div>
<div class="form-group">
